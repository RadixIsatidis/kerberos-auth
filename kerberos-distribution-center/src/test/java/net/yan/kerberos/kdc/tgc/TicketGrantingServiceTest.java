...
public class TicketGrantingServiceTest extends DefaultSettingsTest {
    ...
    public void setUp() throws Exception {
        ...
        if (null == tgs) {
            ...
            tgs.setCipherProvider(cipherProvider);
        }
        ...
        if (null == ticketGrantingServiceRequest) {
            ...
            ticketGrantingServiceRequest.setAuthenticatorString(cipherProvider.encryptObject(authenticator, clientTicketGrantingTicket.getSessionKey()));
        }
