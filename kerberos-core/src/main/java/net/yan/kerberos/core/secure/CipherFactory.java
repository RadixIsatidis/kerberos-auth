...
public interface CipherFactory {
     ...
     */
    Cipher getCipher(CipherSettings settings)
     ...
     */
    SecretKey generateKey(CipherSettings settings, KeySpec keySpec)
     ...
     * @see #generateKey(CipherSettings, KeySpec)
     * @see KeySpecGenerator#generator(String)
     */
    SecretKey generateKey(CipherSettings settings, String key)
